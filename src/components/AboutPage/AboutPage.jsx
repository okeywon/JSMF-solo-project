  ...
  return (
    <div className="about-container">
      <div className="info">
        ...
        <button className="donate"><a href="https://gf.me/u/zb8by7" target="_blank">Donate</a></button>
      </div>
    </div>
  );
}
